...
<template>
  ...
  >
    ...
    <div class="flex items-center pr-10 space-x-4">
      <div class="p-1 hover:bg-gray-600 rounded-full cursor-pointer">
  ...
  <div
    id="SideNav"
    class="fixed w-[240px] bg-[#191922] h-screen border-r border-r-[#32323D]"
  >
    ...
    <div class="text-[#A2A2AD] font-light text-xs pl-16 mt-6 space-y-2">
      <div class="hover:text-[#EF5465] cursor-pointer">Favourite tracks</div>
      <div class="hover:text-[#EF5465] cursor-pointer">Playlist</div>
      <div class="hover:text-[#EF5465] cursor-pointer">Albums</div>
      <div class="hover:text-[#EF5465] cursor-pointer">Artists</div>
      <div class="hover:text-[#EF5465] cursor-pointer">Podcasts</div>
    </div>
  </div>
